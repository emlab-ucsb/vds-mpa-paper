...
```{r, out.width = "250px"}
knitr::include_graphics("../img/PNA_map.png")
```
...
- 10-patch spatial bioeconomic model of the tuna fishery
...
$$\pi_i = pqX_i\Omega_i- \beta cE_i^{\beta-1}$$
