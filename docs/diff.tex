...
\begin{sciabstract}
Will rights-based approaches to managing natural resources facilitate, or \DIFdelbegin \DIFdel{relegate }\DIFdelend \DIFaddbegin \DIFadd{impede }\DIFaddend large-scale conservation? We study this question in the context of large-scale marine protected areas, and ask whether a country \DIFdelbegin \DIFdel{who }\DIFdelend \DIFaddbegin \DIFadd{that }\DIFaddend commits to large-scale conservation is destined to suffer commensurate losses in fishery income.  Indeed, this is a question \DIFdelbegin \DIFdel{island (and other) }\DIFdelend \DIFaddbegin \DIFadd{maritime }\DIFaddend nations all over the world face as they consider whether, and how, to comply with various international commitments to \DIFdelbegin \DIFdel{massively }\DIFdelend expand marine protection. We use a combination of spatial bioeconomic modeling, which accounts for fisheries markets such as the vessel-day trading scheme in the Pacific \DIFaddbegin \DIFadd{Ocean}\DIFaddend , and vessel-level empirical data on fishing behavior before and after MPA implementation, to assess how market design incentivizes, or \DIFdelbegin \DIFdel{relegates }\DIFdelend \DIFaddbegin \DIFadd{penalizes }\DIFaddend conservation. The answer hinges critically on two design features of the rights-based fishery market. First, only if trading of harvest or vessel-days is allowed across countries can a conservation-minded country capture the economic spillover benefits of their conservation \DIFaddbegin \DIFadd{actions}\DIFaddend .  Instead, if trading is forbidden, countries are likely to suffer \DIFdelbegin \DIFdel{significant }\DIFdelend losses from conservation. Second, \DIFdelbegin \DIFdel{as rights are re-allocated between countriesperiodically, the re-allocation }\DIFdelend \DIFaddbegin \DIFadd{when rights are allocated between countries, the allocation }\DIFaddend must depend only on biological features, and not on \DIFaddbegin \DIFadd{economic factors such as }\DIFaddend a country's past effort or catch. Otherwise, the \DIFdelbegin \DIFdel{reallocation }\DIFdelend \DIFaddbegin \DIFadd{allocation process }\DIFaddend acts as a punishment to the conserving country. Overall, these results show that seemingly innocuous design features of a market can have indelible impacts on a country's willingness to engage in large-scale conservation; these results are confirmed with an empirical case study from the Phoenix Islands Protected Area, one of the world's largest marine reserves. \DIFaddbegin \DIFadd{With the right design features, large-scale protected areas such as the Phoenix Islands can be achieved at close to zero cost to the implementing country.
}\DIFaddend \end{sciabstract}
...
In addition to highly productive tuna fisheries, the PNA waters provide a wealth of other ecosystem benefits\DIFdelbegin \DIFdel{; this explains why international attention has focused there for targeted conservation efforts to help achieve the previously mentioned targets. But the }\DIFdelend \DIFaddbegin \DIFadd{, hence the focus on large-scale conservation efforts in the region. The }\DIFaddend PNA member nations derive enormous benefits from leasing tuna fishing rights to foreign fleets, \DIFdelbegin \DIFdel{often }\DIFdelend \DIFaddbegin \DIFadd{in some cases }\DIFaddend exceeding 50\% of a country's \DIFaddbegin \DIFadd{annual }\DIFaddend revenue. A natural concern arises: \DIFdelbegin \DIFdel{Even }\DIFdelend \DIFaddbegin \DIFadd{even }\DIFaddend if the closure creates net benefits to the world, and perhaps even to tuna fisheries Pacific-wide, the economic loss to the conserving country could still be \DIFdelbegin \DIFdel{enormous}\DIFdelend \DIFaddbegin \DIFadd{extremely large}\DIFaddend , and may prevent it from engaging in any meaningful conservation. Intuitively, then, it seems that a country's willingness to engage in large-scale conservation will depend crucially on whether it can successfully capture a sufficiently high fraction of the benefits that are derived from that conservation. We show how \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{a }\DIFaddend rights-based fisheries market can be designed (if it is new) or modified (if it already exists) to ensure that the conserving country is rewarded, not punished, for large-scale conservation.

We develop a 10-patch spatial bioeconomic model of a fishery operating under a vessel-day scheme (VDS), and where conservation is being considered. \DIFaddbegin \DIFadd{A VDS is a type of rights-based management approach used by the PNA where each country is given an allocation of vessel-days that can then be sold to fishing firms. A vessel-day for country $i$ gives a firm the right to have one vessel fish in country $i$'s EEZ for 24 hours. }\DIFaddend Patches 1 - 9 operate under a VDS and Patch 10 represents the high seas in open access. Patch 1 considers closing a portion of its waters \DIFaddbegin \DIFadd{as a reserve }\DIFaddend ($R$, between 0 and 1). There are a total of 45,000 vessel-days, equally distributed between the 9 VDS-managed patches. The fishery revenue to \DIFaddbegin \DIFadd{each of }\DIFaddend these patches is the product of within-patch vessel-days and vessel-day price. Fishing vessels decide to fish in each patch based on available biomass (\emph{i.e.} biomass not within a reserve), and are willing to pay a vessel-day price that equates to \DIFdelbegin \DIFdel{their marginal profits at }\DIFdelend \DIFaddbegin \DIFadd{the marginal profits of }\DIFaddend the last unit of effort applied. Total biomass is equally distributed across the 10 patches. The stock remains within each patch during the fishing season, but growth from escapement is equally distributed across the 10 patches.

We test the implications of conservation under two market designs: one in which effort trading between countries is not allowed, and one where vessel-days can be traded between countries. \DIFdelbegin \DIFdel{On }\DIFdelend \DIFaddbegin \DIFadd{In }\DIFaddend both cases we solve for the equilibrium vessel-day price and effort redistribution. We quantify the losses by comparing revenues from each scenario to a benchmark scenario without \DIFdelbegin \DIFdel{conservation}\DIFdelend \DIFaddbegin \DIFadd{any conservation action}\DIFaddend . The fishery is simulated for a range of reserve sizes and assumptions about within-patch stock movement. \DIFdelbegin \DIFdel{We then examine the role of vessel-day allocation rules, where }\DIFdelend \DIFaddbegin \DIFadd{The second market design feature we investigate is the allocation of rights. We vary the degree to which }\DIFaddend periodic allocation is \DIFdelbegin \DIFdel{a weighted combination of }\DIFdelend \DIFaddbegin \DIFadd{based on }\DIFaddend historical within-patch effort \DIFdelbegin \DIFdel{and biomass }\DIFdelend \DIFaddbegin \DIFadd{versus the actual abundance of fish biomass in a patch}\DIFaddend . Finally, we use vessel-tracking data \DIFaddbegin \DIFadd{and official reports of government revenue }\DIFaddend to corroborate our results by looking at the Phoenix Islands Protected Area, implemented in 2015 by Kiribati within the PNA. \DIFdelbegin \DIFdel{We use the same data and insights from our model to hypothesize what might be the impacts of the proposed Palau National Marine Sanctuary, targeting an 80\% closure of its Exclusive Economic Zone \mbox{%DIFAUXCMD
\cite{cimino_2019}}\hspace{0pt}%DIFAUXCMD
.
}\DIFdelend \DIFaddbegin \textbf{\DIFadd{We use the same data and insights from our model to hypothesize what might be the impacts of the proposed Palau National Marine Sanctuary, currently targeting an 80\% closure of its Exclusive Economic Zone \mbox{%DIFAUXCMD
\cite{cimino_2019}}\hspace{0pt}%DIFAUXCMD
.}}
\DIFaddend 

We begin by simulating a fishery where effort is not traded between countries. We find that a spatial closure in Patch 1 will always result in a loss in revenues \DIFaddbegin \DIFadd{to Patch 1 }\DIFaddend (Fig. \ref{fig:PNA_model}A). Closing a greater proportion of the patch results in greater costs, but these decrease if within-patch stock movement ($\theta$) increases\DIFaddbegin \DIFadd{, allowing vessels to harvest the stock within the remaining open area}\DIFaddend . The closure-to-cost ratio for any reserve size is greater than 1:1 when stock movement is low (\emph{i.e.} $\theta < 0.2$), implying that a 30\% closure would result in at least a 30\% loss in revenues. Even for a highly mobile stock, a reserve reduces the amount of biomass that is available for harvest in Patch 1, which reduces a vessel's willingness to pay to fish in such waters (Fig. \ref{fig:vessel_day_price_no_trading_plot}). When countries \DIFdelbegin \DIFdel{can not }\DIFdelend \DIFaddbegin \DIFadd{cannot }\DIFaddend trade, the costs of conservation are large and incurred by Patch 1, but the benefits are received by the eight other patches \DIFaddbegin \DIFadd{(Figure S2 shows that the increase in revenue ranges from 0\% to 6\%)}\DIFaddend .

How would a different market design, where trading between countries is allowed, change these results? To answer this we simulate the \DIFaddbegin \DIFadd{exact }\DIFaddend same fishery, but now allow for vessel-days to be traded \DIFdelbegin \DIFdel{between }\DIFdelend \DIFaddbegin \DIFadd{across }\DIFaddend patches. A closure in Patch 1 lowers the value of vessel-days in that patch. Vessel-days in patches 2 - 9 are \DIFaddbegin \DIFadd{now }\DIFaddend worth more causing vessel-days from Patch 1 to be \DIFdelbegin \DIFdel{sold }\DIFdelend \DIFaddbegin \DIFadd{traded }\DIFaddend to Patches 2 - 9. Trading continues until vessel-day prices are the same across all patches (Fig. \ref{fig:vessel_day_price_with_trading_plot}). Under this market design, we find that revenue losses are less than 1\%, compared to the benchmark scenario with no reserve (Fig. \ref{fig:PNA_model}). This means that between 88\% and 99\% of the costs \DIFaddbegin \DIFadd{of conservation }\DIFaddend can be avoided if markets are designed to enable trading (Fig. \ref{fig:PNA_model}C).

A second concern about spatial closures in fishing effort markets is that of the \DIFdelbegin \DIFdel{re-allocation }\DIFdelend \DIFaddbegin \DIFadd{allocation }\DIFaddend rules and their implications for costs and \DIFaddbegin \DIFadd{the }\DIFaddend long-term sustainability of the \DIFdelbegin \DIFdel{reserves. If re-allocation depends }\DIFdelend \DIFaddbegin \DIFadd{closures. If allocation rules updates based }\DIFaddend on the historical patch-level effort, \DIFaddbegin \DIFadd{then }\DIFaddend trading vessel-days to other countries would imply a \DIFdelbegin \DIFdel{reduction in allocations through time}\DIFdelend \DIFaddbegin \DIFadd{future reduction in allocation}\DIFaddend . We simulate the fishery 50 years into the future and annually re-allocate vessel-days based on a 7-year running mean of patch-level effort and biomass. We use a range of allocation rules to weight effort ($\alpha$) and biomass ($1 - \alpha$) and compare the revenues to a fishery operating for 50 years without any closures. We find that when allocation is based on historical effort only (\emph{i.e.} $\alpha = 1$), implementing a reserve results in losses of 20\% to 93\%, depending on the size of reserve and stock movement (Fig. \ref{fig:allocation_cost_plot}). However, these costs are reduced as the weight on historical biomass is increased. A biomass-only allocation rule (\emph{i.e.} $\alpha = 0$) results in costs as low as 0.1\% to 0.7\%, essentially eliminating the costs of conservation.

We have shown that rights-based fisheries management may reduce the costs of conservation if trading is allowed, and that the costs can be further reduced if the allocation of rights is based on biomass, rather than on effort. We now move to an empirical setting where we use the implementation of one of the world's largest MPAs \DIFdelbegin \DIFdel{(implemented in the PNA) }\DIFdelend and vessel-tracking data to identify the effort displacement and possible costs \DIFdelbegin \DIFdel{, as well as the behavioral responses of fishing vessels. We then combine our predictions and empirical results to provide likely outcomes of upcoming large-scale MPAs in the region.
}\DIFdelend \DIFaddbegin \DIFadd{of conservation. }\textbf{\DIFadd{We then combine our predictions and empirical results to predict the likely outcomes of upcoming large-scale MPAs in the region.}}
\DIFaddend 
...
Our analysis suggests that the implementation of PIPA resulted in a decrease in fishing effort \DIFdelbegin \DIFdel{applied to Kiribati}\DIFdelend \DIFaddbegin \DIFadd{within Kiribati's waters}\DIFaddend . But does this result in losses to Kiribati? We do not explicitly observe trading between countries, but combining different sources of information we are able to paint a comprehensive picture. We use country-level fisheries revenue data reported by the Pacific Islands Forum Fisheries Agency (FFA) for the 2008 - 2016 period to complement our analysis (Fig. \ref{fig:revenues}A). We observe that Kiribati's reported revenue increased from \$127.3 million USD in 2014 to \$148.8 million USD in 2015, before decreasing to \$118.3 million USD in 2016. This increase and subsequent decrease in revenues \DIFdelbegin \DIFdel{match the }\DIFdelend \DIFaddbegin \DIFadd{matches the AIS }\DIFaddend patterns we observe for Kiribati in 2014 - 2016 (\DIFdelbegin \DIFdel{Figs}\DIFdelend \DIFaddbegin \DIFadd{Fig}\DIFaddend . \ref{fig:all_PS_VDS_year}A), and observed \DIFdelbegin \DIFdel{effort was a good predictor of revenue }\DIFdelend \DIFaddbegin \DIFadd{AIS effort is a reliable predictor of government fishing license revenue across all PNA countries from 2008 to 2016 }\DIFaddend (Fig. \ref{fig:revenue_FFA_effort_GFW}). \DIFdelbegin \DIFdel{Unless At the PNA-level}\DIFdelend \DIFaddbegin \DIFadd{At the PNA level}\DIFaddend , total revenues showed a net increase of \$64.7 and \$28 million USD for 2015 and 2016 \DIFdelbegin \DIFdel{, }\DIFdelend respectively (Fig. \ref{fig:total_PNA_revenues}).

We also inspect the crowding effects that may arise by applying more (or the same) fishing effort over less fishing area by inspecting the spatial overlap between displaced and non-displaced vessels. These groups interacted more with each other after the implementation of PIPA (Table \ref{tab:sp_corr}, Fig. \ref{fig:sp_corr}). The number of cells with presence from both fleets and \DIFaddbegin \DIFadd{the }\DIFaddend spatial correlation between fleets \DIFdelbegin \DIFdel{increase }\DIFdelend \DIFaddbegin \DIFadd{increases }\DIFaddend by a factor of four and three, respectively. Environmental variation may certainly drive this, but the NINO4 anomaly alone explained just 3\% and 7\% of the variation in our crowding measures, compared to the 70\% variation explained when accounting for PIPA implementaiton. We observe similar patterns when \DIFdelbegin \DIFdel{repplicating }\DIFdelend \DIFaddbegin \DIFadd{replicating }\DIFaddend the crowding exercise for Kiribati's EEZ only (Table \ref{tab:KIR_sp_corr}, Fig \ref{fig:KIR_sp_corr}).
