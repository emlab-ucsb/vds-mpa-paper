...
# Read the tracks
vessel_tracks <- readRDS(file = here::here("raw_data", "JPN_tracks.rds"))
...
# Save data
saveRDS(vessel_tracks_baci, file = here::here("data", "JPN_vessel_tracks_baci.rds"))
