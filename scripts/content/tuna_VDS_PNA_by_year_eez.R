...
#Save plot
ggsave(p12, filename = here::here("docs", "img", "all_TS_VDS_cty_year.pdf"), width = 6, height = 7)
...
# Save plot
ggsave(p3, filename = here::here("docs", "img", "all_TS_VDS_cty_month.pdf"), width = 6, height = 4)
