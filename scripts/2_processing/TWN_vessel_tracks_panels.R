...
# 
# PANEL 6:
# - daily proportion fishing hours in Kiribati EEZ
# 
# PANEL 7:
# - daily proportion of fishing hours inside PNA EEZs
##################################################################################
...
# Load the data
vessel_tracks_baci <- readRDS(file = here::here("data", "TWN_vessel_tracks_baci.rds")) %>% 
  filter(baci_strict)
...
saveRDS(daily_hours_by_vessel_panel,
        file = here::here("data", "panels", "TWN", "TWN_daily_hours_by_vessel_panel.rds"))
...
saveRDS(daily_prop_fishing_hours_by_vessel_panel,
        file = here::here("data", "panels", "TWN", "TWN_daily_prop_fishing_hours_by_vessel_panel.rds"))
...
saveRDS(daily_distance_by_vessel_panel,
        file = here::here("data", "panels", "TWN", "TWN_daily_distance_by_vessel_panel.rds"))
...
saveRDS(distance_from_port_shore_by_vessel_panel,
        file = here::here("data", "panels", "TWN", "TWN_distance_from_port_shore_by_vessel_panel.rds"))
...
saveRDS(distance_from_port_shore_fishing_by_vessel_panel,
        file = here::here("data", "panels", "TWN", "TWN_distance_from_port_shore_fishing_by_vessel_panel.rds"))
...
######################## BEGIN PANEL 6 ##########
# MONTHLY HOURS FISHING IN KIR EEZ
KIR_fishing_hours_by_vessel_panel <- vessel_tracks_baci %>%
  filter(fishing,
         eez_iso3 == "KIR") %>% # Keep only KIR fishing hours) %>% 
  group_by(year,
           quarter,
           month,
           year_month,
           ...
           month_c,
           year_c) %>%
  summarize(kir_hours = sum(hours, na.rm = T)) %>% #Calculate total hours per vessel-month
  ungroup() %>% 
  arrange(year, month, mmsi)

# Save the data
saveRDS(KIR_fishing_hours_by_vessel_panel,
        file = here::here("data", "panels", "TWN", "TWN_KIR_fishing_hours_by_vessel_panel.rds"))
...
######################## BEGIN PANEL 7 ##########
# MONTHLY HOURS FISHING IN VDS EEZ
...
VDS_fishing_hours_by_vessel_panel <- vessel_tracks_baci %>%
  filter(fishing,
         eez_iso3 %in% VDS_countries) %>% #Keep only VDS countries
  group_by(year,
           quarter,
           month,
           year_month,
...
saveRDS(VDS_fishing_hours_by_vessel_panel,
        file = here::here("data", "panels", "TWN", "TWN_VDS_fishing_hours_by_vessel_panel.rds"))
