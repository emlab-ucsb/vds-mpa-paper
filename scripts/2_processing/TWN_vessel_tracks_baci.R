#################################
#     TWN_vessel_tracks_baci    #
#################################

##################################################################################
# The objective of this script is to clean and formalize the vessel_tracks data.
...
# Read the tracks
vessel_tracks <- readRDS(file = here::here("raw_data", "TWN_tracks.rds"))
...
# Save data
saveRDS(vessel_tracks_baci, file = here::here("data", "TWN_vessel_tracks_baci.rds"))
